...
<template>
    <div class="container mt-4">
        <div class="row">
            ...
            <div class="col-md-7">
                <div class="card shadow">
                    <div class="card-header  text-white" style="background: #47fa9b">
                    ...
                    <div class="card-body">
                        <form @click.prevent>
                            ...
                            <div class="mb-2">
                                <p type="submit" @click="submitForm" class="btn btn-primary shadow d-block" style="background: #47fa9b">สมัครสมาชิก</p>
